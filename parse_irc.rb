...
CSV.open(out, 'w') do |csv|
  ...
  parser = TextualParser.new TextualLineParser.new, SlowTextualLineParser.new, ServerMaps::OLDER_MAC
  parser.parse('../ircdev/2013.08.25-2015.03.16/') do |msg|
    csv << msg.to_csv
  end

  parser = Old2Parser.new OldHexchatLineParser.new, DotLogLineParser.new, ServerMaps::OLD_WINDOWS
